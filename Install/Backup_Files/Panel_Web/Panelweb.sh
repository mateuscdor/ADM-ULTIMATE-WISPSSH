...
sleep 1
cd
wget https://raw.githubusercontent.com/wispssh/ADM-ULTIMATE-WISPSSH/main/Install/Panel_Web/panel_v10/plus.sql > /dev/null 2>&1
sleep 1
...
echo -e "\033[1;37mwget https://raw.githubusercontent.com/wispssh/ADM-ULTIMATE-WISPSSH/main/Install/Panel_Web/panel_v10/revenda/confpainel/inst && bash inst\033[0m"
...
sleep 1
cd
wget https://raw.githubusercontent.com/wispssh/ADM-ULTIMATE-WISPSSH/main/Install/Panel_Web/panel_v11/sshplus.sql > /dev/null 2>&1
sleep 1
...
echo -e "${cor[2]} [2] > ${cor[3]}PANEL SSHPLUS WEB V11"
echo -e "${cor[2]} [3] > ${cor[3]}PANEL SSHPLUS WEB V15"
echo -e "${cor[2]} [4] > ${cor[3]}ELIMINAR PANEL SSHPLUS"
