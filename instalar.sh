...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   ...
   wget -O $HOME/LICENCIA.txt https://raw.githubusercontent.com/wispssh/ADM-ULTIMATE-WISPSSH/main/LICENCIA.txt &> /dev/null
   wget -O $HOME/versao https://raw.githubusercontent.com/wispssh/ADM-ULTIMATE-WISPSSH/main/versao &> /dev/null
   wget -O /bin/versao_script https://raw.githubusercontent.com/wispssh/ADM-ULTIMATE-WISPSSH/main/Install/versaoatt &> /dev/null
   inst_components
   install_hosts
