...
# wget -O /etc/pam.d/common-password https://raw.githubusercontent.com/wispssh/ADM-ULTIMATE-WISPSSH/main/Install/common-password 
...
txt[327]="AUTENTICACAO DO L�QUIDO DE PROXY DESACTIVADO."
